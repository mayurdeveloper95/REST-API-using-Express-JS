...
//get movieData by id
route.get("/getmoviesid/:id",(req,res)=>
{
...
route.get("/getmoviescondition",(req,res)=>
{
...
route.post("/createmovies",(req,res)=>
{
...
//update date by id
route.put("/updatemovies/:id",(req,res)=>
{
...
//delete data by id
route.delete("/deletemovies/:id",(req,res)=>
{
